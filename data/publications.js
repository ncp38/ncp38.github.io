...
const DISSTITLE = "IEEE SoutheastCon 2011 Hardware Competition";
const DISSKEYWORDS = ["Robotics", "C", "Arduino", "Electrical Engineering", "Emergency Response"];
const DISSYEAR = 2011;
...
const PUB1YEAR = 2012;
const PUB1DESCRIPTION = "This PUBect uses parallel coordinates to graph yearly hurricane data.  It contains interactive features including selectable ranges, re-orderable rows, low-opacity lines, and multivariate functionality. Based on a data set created by Dr. William Gray.";
...
const PUB6TITLE = "Plagiarism Detection Visualization";
const PUB6KEYWORDS = ["Web Design", "Visualization"];
const PUB6YEAR = 2014;
const PUB6DESCRIPTION = "My team created a website that would compare two input text files and determine any potential plagiarized phrases between them. Based on this analysis, both files are displayed side-by-side in a scrollable view with the potentially plagiarized phrases highlighted in both documents.";
